...
ACCESSORY_VALUES = {
    ...
    "windscreen": 40,
    "heated_grips": 60,
    "luggage_quality": 250,   # Качественные кофры (брендовые боковые + топкейc)
    "luggage_basic": 120,     # Базовые универсальные сумки / мягкие кофры
    "new_tires": 180,
    "fresh_chainkit": 120,
    "phone_mount": 20,
    "aux_lights": 70,
...
# Локализованные подписи и подсказки
ACCESSORY_LABELS_RU = {
    "abs": ("ABS", "Антиблокировочная система — повышает безопасность"),
    "exhaust_brand": ("Спортивный выхлоп", "Брендовый глушитель, лёгкая прибавка стоимости"),
    "crashbars": ("Дуги защиты", "Защита при падении"),
    "windscreen": ("Ветровик", "Комфорт на скорости"),
    "heated_grips": ("Подогрев ручек", "Актуально для холодного сезона"),
    "luggage_quality": ("Кофры (бренд)", "Жёсткие/качественные кофры комплект"),
    "luggage_basic": ("Кофры (базовые)", "Простые/мягкие сумки"),
    "new_tires": ("Новая резина", "<=500 миль, экономит ~180$"),
    "fresh_chainkit": ("Набор цепь/звёзды", "Недавно заменены"),
    "phone_mount": ("Держатель телефона", "Небольшая полезная мелочь"),
    "aux_lights": ("Доп. свет", "Лучше видимость"),
    "quickshifter": ("Quickshifter", "Быстрые переключения передач"),
    "frame_sliders": ("Слайдеры рамы", "Минимизация урона при падении"),
    "radiator_guard": ("Защита радиатора", "Предотвращает повреждения камнями"),
